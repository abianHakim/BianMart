                ...
                <div class="card o-hidden border-0 shadow-lg">
                    <div class="card-body p-5">
                        <div class="text-center">
                            ...
                            <h1 class="h4 text-gray-900 mb-4">Welcome To Member!</h1>
                        </div>

                        <form class="user" action="{{ route('member.login.submit') }}" method="POST">
                            @csrf
                            <div class="form-group">
                                <input type="text" class="form-control" name="no_telp"
                                    placeholder="Enter Phone Number (No. Telp)" required autofocus autocomplete="off"
